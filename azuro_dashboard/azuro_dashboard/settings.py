"""
Django settings for azuro_dashboard project.
...
ALLOWED_HOSTS = ['azuro.pythonanywhere.com', ]
...
ROOT_URLCONF = 'azuro_dashboard.urls'
...
WSGI_APPLICATION = 'azuro_dashboard.wsgi.application'
